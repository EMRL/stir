...
function init_env() {
  var=(CLEARSCREEN WORKPATH CONFIGDIR REPOHOST SMARTCOMMIT GITSTATS \
  EMAILHTML NOPHP TO FROM SUBJECT EMAILERROR EMAILSUCCESS EMAILQUIT \
  ...
  MAILPATH REQUIREAPPROVAL ADDTIME SCPPORT TASKUSER CLIENTID CLIENTSECRET \
