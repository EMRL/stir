...
function update_project() { 
  ...
  env_settings=(PROJNAME PROJCLIENT DEVURL PRODURL REPOHOST REPO MASTER \
    ...
    IN_ITEM_QTY IN_NOTES IN_INCLUDE_REPORT IN_EMAIL CLIENTID CLIENTSECRET \
    REDIRECTURI AUTHORIZATIONCODE ACCESSTOKEN REFRESHTOKEN PROFILEID \
    MONITORURL MONITORUSER MONITORPASS SERVERID NIKTO NIKTO_CONFIG \
    ...
    GRAVITY_FORMS_LICENSE INCLUDE_DETAILS)
