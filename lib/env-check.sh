...
function update_project() { 
  ...
  env_settings=(PROJNAME PROJCLIENT DEVURL PRODURL REPOHOST REPO MASTER \
    ...
    CLIENTCONTACT INCLUDEHOSTING IN_HOST IN_TOKEN IN_CLIENT_ID IN_PRODUCT \
    IN_ITEM_COST IN_ITEM_QTY IN_NOTES CLIENTID CLIENTSECRET REDIRECTURI \
    ...
    DB_API_TOKEN DB_BACKUP_PATH PREPARE PREPARE_CONFIG ACF_LOCK STAGING)
