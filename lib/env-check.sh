...
function update_global() {
  ...
  env_settings=(CLEARSCREEN WORKPATH CONFIGDIR SERVERCHECK ACTIVECHECK \
    ...
    REMOTEURL REMOTETEMPLATE SCPPOST SCPUSER SCPHOST SCPHOSTPATH SCPPASS \
    LOCALHOSTPOST LOCALHOSTPATH EXPIRELOGS)
...
function update_project() { 
  ...
  env_settings=(PROJNAME PROJCLIENT DEVURL PRODURL REPOHOST REPO MASTER \
    ...
    REMOTEURL REMOTETEMPLATE SCPPOST SCPUSER SCPHOST SCPHOSTPATH SCPPASS \
    LOCALHOSTPOST LOCALHOSTPATH DIGESTEMAIL CLIENTCONTACT INCLUDEHOSTING \
    ...
    REFRESHTOKEN PROFILEID MONITORURL MONITORUSER MONITORPASS SERVERID)
