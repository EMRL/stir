...
![GitHub release](https://img.shields.io/github/v/release/emrl/stir?sort=semver) ![GitHub issues](https://img.shields.io/github/issues/emrl/stir) ![Build Status](https://travis-ci.org/EMRL/stir.svg?branch=master)
